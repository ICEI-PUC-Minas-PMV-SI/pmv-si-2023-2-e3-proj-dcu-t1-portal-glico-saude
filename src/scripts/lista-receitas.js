...
function selector(id){
  if (verify(id) == true){
     document.getElementById("like-button").innerHTML = "Descurtir"
     document.getElementById("like-button").className = "dislike-button"
     document.getElementById("like-button").addEventListener ("click", () => dislike(id))
  }
  else {
     document.getElementById("like-button").innerHTML = "Curtir"
     document.getElementById("like-button").className = "like-button"
     document.getElementById("like-button").addEventListener ("click", () => like(id))
  }
   for(let index in recipeList){
       item = recipeList[index]
       if (id==item["id"]){
           document.getElementById("Título").innerHTML = item["titulo"];
           document.getElementById("Preparo").innerHTML = item["preparo"];
           document.getElementById("Imagem").src = item["imagem"];
           var ul = document.getElementById("Ingredientes");

           for(let index2 in item["ingredientes"]){
               ingredient = item["ingredientes"][index2]
...
function like (id){
  ...
  document.getElementById("like-button").innerHTML = "Descurtir"
  document.getElementById("like-button").className = "dislike-button"
  var old_element = document.getElementById("like-button");
